...
export default function Reuse() {
    ...
    const form = (
        < Box sx={{ marginTop: '35px', py: 3, borderRadius: "2px", width: "100%", height: "100%" }}>
            ...
            <form sx={{ padding: "5px", display: "flex" }}>
                ...
                <Grid container spacing={3} sx={{ p: 2 }}>
                    ...
                    <Grid item sm={6} xs={12} md={4} >
                        <TextField
                            ...
                            variant="outlined"
                            {...register("Status", { required: "Enter the Status", maxLength: { value: 10, message: 'maximum length is 10 ' }, })}
                            error={Boolean(errors.Status)} helperText={errors.Status?.message}
                            fullWidth size="small" placeholder="Status"
                        >
                    ...
                    <Grid item sm={6} xs={12} md={4} >
                        <TextField sx={{}}
                            ...
                            fullWidth size="small" placeholder="Location"
                ...
                <Grid item sx={{ p: 1, marginLeft: "12px" }}>
                    <Link to='/user' style={{ textDecoration: 'none' }}>
                        <Button variant="contained" disableRipple disableElevation sx={{ my: 5, background: 'rgba(26,188,156,255)' }}>Back</Button>
                    </Link>
                </Grid>
            </form>
